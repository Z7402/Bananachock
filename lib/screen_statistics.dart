      ...
      child: Column(
        ...
        children: [
                ...
                Text('本周总计',
                    style: TextStyle(
                        ...
                        color: cs.onSecondaryContainer
                            .withValues(alpha: 0.7))),
                Text('${totalWeek.toStringAsFixed(1)} h',
                    style: TextStyle(
                        fontSize: 36,
                        fontWeight: FontWeight.w700,
                        color: cs.onSecondaryContainer)),
          ...
          SizedBox(
            height: 260,
            child: _WeeklyChart(
                dailyHours: dailyHours, maxY: maxY),
          ),
          const SizedBox(height: 16),
          // 每日详情可展开
          ...List.generate(7, (i) {
            ...
            return Card(
              ...
              child: ExpansionTile(
                title: Text(
                    '${DateFormat('MM/dd EEEE', 'zh_CN').format(date)}  ${hours.toStringAsFixed(1)}h'),
                ...
                Text('${now.month}月总计',
                    style: TextStyle(
                        ...
                        color: cs.onTertiaryContainer
                            .withValues(alpha: 0.7))),
                Text('${totalMonth.toStringAsFixed(1)} h',
                    style: TextStyle(
                        fontSize: 36,
                        fontWeight: FontWeight.w700,
                        color: cs.onTertiaryContainer)),
...
class _CategoryPieChart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final totalSeconds = categoryDurations.values
        ...
        Expanded(
          ...
          child: PieChart(PieChartData(
            sections: entries.map((entry) {
              final pct = (entry.value.inSeconds /
                      totalSeconds *
                      100)
                  .toStringAsFixed(0);
...
class _WeeklyChart extends StatelessWidget {
  ...
  final double maxY;
  const _WeeklyChart(
      {required this.dailyHours, required this.maxY});
